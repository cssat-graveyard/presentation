// <![CDATA[
           var context_w = 714,
            ...
            var margin_p = {top: 0, right: 5, bottom: 0, left: 0},  // layout for population fast facts
            ...
            var margin_t = {top: 5, right: 5, bottom: 5, left: 35},  // layout for trends
                width_t = 350 - margin_t.left - margin_t.right,
                height_t = 90 - margin_t.top - margin_t.bottom,
                sparkline_w = 240,
                sparkline_h = 90;
                
            var fast_fact_desc = fast_fact_desc;  // change them once get the real description file
            ...
            d3.select("#wa_geo_map").selectAll("g").attr("class","hint--top"); 
            d3.select("#wa_geo_map").selectAll("g").attr("data-hint","Title text"); 
